...
<body>
    ...
    <?php
            include 'koneksi.php';
            $uangMasuk = mysqli_query($koneksi, "SELECT * FROM uang_masuk");
    ?>
        ...
        <div class="container">
            ...
            <div class="col-md-4 mb-2">
                <a href="index.php?page=uang-masuk&task=input" class="btn btn-primary">Input Data Uang Masuk</a>
            </div>
            <table class="table table-bordered table-hover table-responsive">
                ...
                <tr>
                    ...
                    <td>
                        <a href="index.php?page=uang-masuk&task=edit&id_edt=<?= $row["id_transaksi"]; ?>" class=" btn btn-warning"><span
                                data-feather="edit" class="align-text-bottom">Edit</span></a>
                        <a href="proses/prosesUangMasuk.php?task=delete&id_hps=<?= $row["id_transaksi"]; ?>"
...
<body>
    <div class="container mt-3 ">
        <div class="col-md-4">
            <?php
                    ...
                    $edit = mysqli_query($koneksi, "SELECT * FROM uang_masuk WHERE id_transaksi='$_GET[id_edt]'");
                    $data = mysqli_fetch_array($edit);

            ?>
            <h2>Form Edit Data Uang Masuk</h2>
            <a href="index.php?page=uang-masuk">Lihat data</a>
            <div class="row">
                <form action="proses/prosesUangMasuk.php?task=edit&id_edt=<?=$_GET['id_edt'];?>" method="post">
                <div class="mb-3">
    ...
    <div class="container mt-3 ">
        <div class="col-md-4">
            <h2>Form Input Data Uang Masuk</h2>
            <a href="index.php?page=uang-masuk">Lihat data</a>
            <div class="row"></div>
            <form action="proses/prosesUangMasuk.php?task=input" method="post">
                <div class="mb-3">
                    <label class="form-label">Nama Transaksi</label>
